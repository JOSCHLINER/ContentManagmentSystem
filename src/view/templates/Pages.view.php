      ...
      <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 border-top mt-auto">
        ...
        <div class="col-md-4 d-flex align-items-center">
          ...
          <div>
            ...
            <span class="text-muted d-flex">Project distributed under GNU General Public License v3.0</span>
          </div>
        </div>

        <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
          <li class="ms-3 justify-content-center">
            <a class="btn btn-outline-secondary link-underline link-underline-opacity-0" href="https://github.com/JOSCHLINER/Markdown-CMS" target="_blank">
              Visit on GitHub
